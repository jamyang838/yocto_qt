...
void CppSignalSender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CppSignalSender *_t = static_cast<CppSignalSender *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CppSignalSender::*_t)(QString );
...
QT_INIT_METAOBJECT const QMetaObject CppSignalSender::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CppSignalSender.data,
      qt_meta_data_CppSignalSender,  qt_static_metacall, nullptr, nullptr}
};
